...
public class TaskPackage {
    ...
    public <T1> TaskPackage(String id, Task1<T1> code, Param<T1> arg) {
        this.id = id;
        this.taskType = 1;
        this.taskParameters = new Object[] { code, arg };
    }

    public <T1, T2> TaskPackage(String id, Task2<T1, T2> code, Param<T1> arg1, Param<T2> arg2) {
        this.id = id;
        this.taskType = 2;
        this.taskParameters = new Object[] { code, arg1, arg2 };
    }

    public <T1, T2, T3> TaskPackage(String id, Task3<T1, T2, T3> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3) {
        this.id = id;
        this.taskType = 3;
    ...
    public <T1, T2, T3, T4> TaskPackage(String id, Task4<T1, T2, T3, T4> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4) {
        this.id = id;
        this.taskType = 4;
        this.taskParameters = new Object[] { code, arg1, arg2, arg3, arg4 };
    }

    public <T1, T2, T3, T4, T5> TaskPackage(String id, Task5<T1, T2, T3, T4, T5> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4, Param<T5> arg5) {
        this.id = id;
        this.taskType = 5;
        this.taskParameters = new Object[] { code, arg1, arg2, arg3, arg4, arg5 };
    }

    public <T1, T2, T3, T4, T5, T6> TaskPackage(String id, Task6<T1, T2, T3, T4, T5, T6> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4, Param<T5> arg5, Param<T6> arg6) {
        this.id = id;
        this.taskType = 6;
        this.taskParameters = new Object[] { code, arg1, arg2, arg3, arg4, arg5, arg6 };
    }

    public <T1, T2, T3, T4, T5, T6, T7> TaskPackage(String id, Task7<T1, T2, T3, T4, T5, T6, T7> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4, Param<T5> arg5, Param<T6> arg6, Param<T7> arg7) {
        this.id = id;
        this.taskType = 7;
        this.taskParameters = new Object[] { code, arg1, arg2, arg3, arg4, arg5, arg6, arg7 };
    }

    public <T1, T2, T3, T4, T5, T6, T7, T8> TaskPackage(String id, Task8<T1, T2, T3, T4, T5, T6, T7, T8> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4, Param<T5> arg5, Param<T6> arg6, Param<T7> arg7, Param<T8> arg8) {
        this.id = id;
        this.taskType = 8;
    ...
    public static <T1, T2> TaskPackage createPackage(String id, Task2<T1, T2> code, Param<T1> arg1, Param<T2> arg2) {
        return new TaskPackage(id, code, arg1, arg2);
    }

    public static <T1, T2, T3> TaskPackage createPackage(String id, Task3<T1, T2, T3> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3) {
        return new TaskPackage(id, code, arg1, arg2, arg3);
    }

    public static <T1, T2, T3, T4> TaskPackage createPackage(String id, Task4<T1, T2, T3, T4> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4) {
        return new TaskPackage(id, code, arg1, arg2, arg3, arg4);
    }

    public static <T1, T2, T3, T4, T5> TaskPackage createPackage(String id, Task5<T1, T2, T3, T4, T5> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4, Param<T5> arg5) {
        return new TaskPackage(id, code, arg1, arg2, arg3, arg4, arg5);
    }

    public static <T1, T2, T3, T4, T5, T6> TaskPackage createPackage(String id, Task6<T1, T2, T3, T4, T5, T6> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4, Param<T5> arg5, Param<T6> arg6) {
        return new TaskPackage(id, code, arg1, arg2, arg3, arg4, arg5, arg6);
    }

    public static <T1, T2, T3, T4, T5, T6, T7> TaskPackage createPackage(String id, Task7<T1, T2, T3, T4, T5, T6, T7> code, Param<T1> arg1, Param<T2> arg2, Param<T3> arg3, Param<T4> arg4, Param<T5> arg5, Param<T6> arg6, Param<T7> arg7) {
